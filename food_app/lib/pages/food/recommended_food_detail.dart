      ...
      Container(
        ...
        child: Row(
          ...
          children: [
            ...
            BigText(text: "\$ ${product.price!}  X  ${controller.inCartItems} ", color: AppColors.mainBlackColor,size: Dimensions.font16,),
            GestureDetector(
              onTap: (){
      ...
      Container(
        ...
        child: Row(
         ...
         Container(
           ...
           child: BigText(text: "\$ ${product.price!} | Kart ile Öde" , color: Colors.white,),
           decoration: BoxDecoration(
             borderRadius: BorderRadius.circular(Dimensions.radius20),
             color: AppColors.mainColor,
           ),
